...
function makeMetaParticle(type)
	...
	if stamps[type] then-- == "bubble" or type == "hadouken" or type == "corn" then
		INTERVAL = 0.05
		...
		--
		-- 		size = {min = 1, var = 1},
		-- 		deltaSize = {min = -0.1, var = 0.2},
		--
		-- 		xVelocity = {min = -2, var = 4},
		-- 		yVelocity = {min = -2, var = 4},
		-- 		xAcceleration = {min = -2, var = 4},
		-- 		yAcceleration = {min = -2, var = 4},
		-- 		xJerk = {min = -0, var = 0},
		-- 		yJerk = {min = -0, var = 0},
		-- 	}
		...
		attributes = {
			...
			variable = {
				...
				deltaG = {min = -2, var = 4},
				deltaB = {min = -2, var = 4},
				deltaA = {min = -16, var = 16},
			
				size = {min = 0.25, var = 0.5},
				deltaSize = {min = -0.1, var = 0.2},
			
				xVelocity = {min = -12, var = 24},
				yVelocity = {min = -12, var = 24},
				xAcceleration = {min = -12, var = 24},
				yAcceleration = {min = -12, var = 24},
				xJerk = {min = -12, var = 24},
				yJerk = {min = -12, var = 24},
			}
		}
	elseif type == "pencil" then
		INTERVAL = 0.02
